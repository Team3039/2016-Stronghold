...
public class PS4Copad extends Joystick {
	...
	private static final int AXIS_L2 = 3;
	private static final int AXIS_R2 = 4;
	...
	/**
	 * Returns the L2 Position
	 */
	public double getL2Axis() {
		return getRawAxis(AXIS_L2);
	}

	/**
	 * Returns the R2 Position
	 */
	public double getR2Axis() {
		return getRawAxis(AXIS_R2);
	}
