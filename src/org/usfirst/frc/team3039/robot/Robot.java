...
import org.usfirst.frc.team3039.robot.commands.AutoSLeft;
import org.usfirst.frc.team3039.robot.commands.AutoSRight;
import org.usfirst.frc.team3039.robot.commands.AutoTest;
import org.usfirst.frc.team3039.robot.commands.Unbrake;
import org.usfirst.frc.team3039.robot.subsystems.DriveTrain;
import org.usfirst.frc.team3039.robot.subsystems.SideShooter;
   ...
   // public static PIDControl pidcontrol;
	...
	public void robotInit() {
       ...
       // pidcontrol = new PIDControl();
    	...
    	autoChooser.addObject("Test", new AutoTest());

    	autoChooser.addObject("AutoCurveRight", new AutoSRight());
    	autoChooser.addObject("AutoCurveLeft", new AutoSLeft());
